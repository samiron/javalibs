...
public class POIEventModelReader {

    private CellValueListener cellValueListener = null;
    private String fileName;
    public POIEventModelReader(String fileName){
    ...
    public void startRead() throws OpenXML4JException, IOException, SAXException {
        ...
        while(sheets.hasNext()) {
            ...
            this.cellValueListener.sheetNameFound(sheetIndex++, sheetName);
            if(sheetName.startsWith("#")){
                System.out.println("Skipping comment sheet");
                continue;
            }
            System.out.println("Processing data sheet: " + sheetName);
    ...
    public interface CellValueListener {
        void sheetNameFound(int sheetIndex, String sheetName);
...
//                    System.out.println(String.format("Printing %s -> %s", this.currentCellReference, this.lastContents));
    ...
    public static void main(String[] args) throws Exception {
        ...
        POIEventModelReader example = new POIEventModelReader(filepath);
        example.startRead();
    }
